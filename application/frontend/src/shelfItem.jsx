...
const ShelfItem  = ({title, unsave, setArticle}) => {
    ...
    return (
        <div className='border-2 rounded-lg border-white w-11/12 mt-5 flex opacity-0 animate-fade-right'>
            ...
            <div onClick = {unsave} className='w-12 h-10 rounded-lg border-2 border-black m-2 flex items-center justify-center bg-red-600 cursor-pointer hover:bg-red-500'>
                X
            </div>
        </div>
    )
